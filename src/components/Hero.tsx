        ...
        <div className="flex w-full flex-col items-center justify-between gap-10 lg:h-[calc(100vh-72px)] lg:flex-row lg:gap-0">
          <div className="flex max-w-[648px] flex-col py-10 lg:py-0 lg:pb-24">
            ...
            <div className="flex items-center">
              ...
              <button className="anim-btn flex -translate-x-4 items-center gap-2 px-6 py-4 font-semibold text-violet-700 opacity-0 hover:text-violet-600">
          ...
          {/* <img
            id="teste"
            className="anim-cel  translate-y-12 pb-20 opacity-0 max-w-[900px] max-h-[600px]  lg:pb-0 lg:pr-20"
            src="/iphone.png"
            alt=""
          /> */}
          <Image
